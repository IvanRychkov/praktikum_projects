...
Этот репозиторий содержит примеры проектов, которые были выполнены мной в ходе обучения профессии "*Специалист по Data Science*" в **Яндекс.Практикуме**. *"Боевые" проекты можно посмотреть в репозитории [ds_portfolio](https://github.com/IvanRychkov/ds_portfolio).*
