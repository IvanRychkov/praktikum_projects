...
| [Защита данных клиентов](https://github.com/IvanRychkov/praktikum_projects/tree/master/Защита%20данных%20клиентов) | Разработка алгоритма для шифрования данных. | Линейная алгебра, машинное обучение | *pandas, NumPy, scikit-learn* |
