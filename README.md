...
| [Выявление токсичных комментариев](https://github.com/IvanRychkov/praktikum_projects/tree/master/Выявление%20токсичных%20комментариев) | Обучение модели классификации для обнаружения токсичных текстов. | NLP, векторизация текстов, классификация, лемматизация, BERT | *pandas, NumPy, NLTK, PyTorch, transformers, Matplotlib, Seaborn, scikit-learn, CatBoost, LightGBM, Joblib* |
